...
export function CalculatorGuide({ content }: { content: CalculatorContent }) {
  return <div className={styles.guide}>
    ...
    <div className={styles.methodologyNote}><span>Transparent assumptions. Practical purchase quantities.</span><Link href="/how-we-calculate">See how we calculate every estimate <span aria-hidden="true">→</span></Link></div>
  </div>;
}
