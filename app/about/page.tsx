...
export const metadata: Metadata = createPageMetadata({
  title: "About",
  description: "Project Buy List helps homeowners and DIY planners estimate material quantities, waste, packages, and costs with transparent formulas.",
  path: "/about",
});

export default function AboutPage() {
  return <ContentPage eyebrow="Built for practical planning" title="About Project Buy List" intro="We build focused tools that turn room measurements and product details into purchase-ready material estimates.">
    <section><h2>Why this site exists</h2><div><p>Home projects often start with a simple question: how much material should I buy? The arithmetic may be straightforward, but openings, waste, product coverage, package sizes, and unit conversions make the final purchase less obvious.</p><p>Project Buy List keeps those steps together and explains them in plain English.</p></div></section>
