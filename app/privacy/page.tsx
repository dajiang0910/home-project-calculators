...
export const metadata: Metadata = createPageMetadata({ title: "Privacy Policy", description: "Privacy information for Project Buy List.", path: "/privacy" });
...
export default function PrivacyPage() {
  return <ContentPage eyebrow="Site information" title="Privacy policy" intro="This page explains what information the site uses today and how future changes will be communicated.">
    ...
    <section><h2>Analytics and advertising</h2><div><p>The current application does not send analytics events to an external service, use advertising, or run behavioral tracking. It exposes a local browser event seam for future measurement; that seam does not store or transmit calculator measurements, prices, results, or user identifiers. If an external service is added, this policy will be updated to identify the service, purpose, and available choices before the change is treated as part of the published site.</p></div></section>
    ...
    <section><h2>Policy changes</h2><div><p>Material changes will be reflected on this page. This policy was last updated on September 19, 2026.</p></div></section>
  </ContentPage>;
}
